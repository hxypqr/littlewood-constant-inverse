...
\fancyhead[C]{\ifodd\value{page}{\small XIYU HU}\else{\small FURTHER REMARKS ON THE INVERSE LITTLEWOOD CONJECTURE}\fi}
\fancyfoot[C]{\thepage}
\setlength{\emergencystretch}{2em}
\hypersetup{pdftitle={Further remarks on the inverse Littlewood conjecture},pdfauthor={Xiyu Hu},pdfsubject={Fourier L1 norms, additive energy, and structured integer sets},pdfkeywords={Littlewood conjecture, inverse theorem, additive energy, outer functions, Sidon sets}}
\title[Further remarks on the inverse Littlewood conjecture]{Further remarks on the inverse Littlewood conjecture}
\author{Xiyu Hu}
